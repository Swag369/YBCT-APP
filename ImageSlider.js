  ...
  handleClick(step) {
    ...
    this.setState((prevState) => ({
      ...
      styles: {
        ...this.state.styles,
        slide_styles: {
          ...this.state.styles.slide_styles,
    ...
    return (
      <div style={{ padding: 0, margin: 0, boxSizing: "border-box" }}>
        <div
          ...
          style={this.state.styles.container_styles}
        >
          <button
            id="ImageSliderPrev"
            onClick={(event) => this.handleClick(-1)}
            style={this.state.styles.prev_button_styles}
          >
            ❮
          </button>
          ...
          <button
            id="ImageSliderNext"
            onClick={(event) => this.handleClick(1)}
            style={this.state.styles.next_button_styles}
          >
            ❯
          </button>
          ...
          >
            <img
              src={this.state.image_urls[this.state.image_urls.length - 1]}
              width="800"
              height="600"
              id="lastClone"
              alt="dummyImage"
