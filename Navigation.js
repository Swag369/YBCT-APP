    ...
    return (
        <header>
            <div className = "navbar">
                ...
                <a href = "https://docs.google.com/forms/d/1tkpKoNENoyoXDtPdCqJ5o_uH72AaH97nhhQjEM4ilGg/edit" target = "_blank" className = "tab">Sign Up</a>
                <a href = "https://www.instagram.com/ybct_saveslives/" target = "_blank" className = "social">
                    <img src = {require("/Users/sahi/ybct/src/images/iconfinder_1_Instagram_colored_svg_1_5296765.png")} width = "40" height = "40" style = {{marginLeft: 20}}></img>
                </a>
                <a href = "https://discord.gg/JsGXYAV" target = "_blank" className = "social">
                    <img src = {require("/Users/sahi/ybct/src/images/iconfinder_91_Discord_logo_logos_4373196.png")} width = "45" height = "45"></img>
                </a>
            </div>
        </header>
    )
